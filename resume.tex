...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {\href{https://www.google.org}{Google.org} + \href{https://aiinstitutes.org}{AI Institutes Virtual Organization}}{Remote}
      {[Upcoming] AIVO Summer Fellow}{[Upcoming] May 2025 -- Aug 2025}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Contributed to 12 peer-reviewed publications (5 as lead author) in venues related to \emph{educational data mining}}
    \resumeItemListEnd
    ...
    {Ida Lawrence Research Intern}{June 2024 -- July 2024}
      \resumeItemListStart
        \resumeItem{Developed simple interpretable models (for ensembling) that detect student reading disengagement}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Demonstrated that the model provides fully faithful explanations utilizing 100\% of its inference parameters}
            % \resumeItem{Evaluated the model's performance and explainability against human expert-identified patterns}
            \resumeItem{Achieved 90\% explanation intelligibility among human subjects}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Ph.D. in Educational Data Science}{Aug 2020 -- July 2025}
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      {B.A. in Ancient Near Eastern Studies}{Jan 2012 -- May 2016}
  \resumeSubHeadingListEnd
